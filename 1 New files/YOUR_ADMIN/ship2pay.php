...
while (!$s2p->EOF) {
  ...
  if ((is_object($trInfo)) && ($s2p->fields['s2p_id'] == $trInfo->fields['s2p_id'])) {
    echo '              <tr id="defaultSelected" class="dataTableRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . zen_href_link(FILENAME_SHIP2PAY, 'page=' . $_GET['page'] . '&s2p_id=' . $trInfo->fields['s2p_id'] . '&action=edit') . '\'">' . "\n";
  } else {
  ...
  ?></td>
                                  <td class="dataTableContent" align="right"><?php if ((is_object($trInfo)) && ($s2p->fields['s2p_id'] == $trInfo->fields['s2p_id'])) {
                                    echo zen_image(DIR_WS_IMAGES . 'icon_arrow_right.gif', '');
                                  } else {
                                    echo '<a href="' . zen_href_link(FILENAME_SHIP2PAY, 'page=' . $_GET['page'] . '&s2p_id=' . $s2p->fields['s2p_id']) . '">' . zen_image(DIR_WS_ADMIN . DIR_WS_ICONS . IMAGE_ICON_INFO, IMAGE_ICON_INFO) . '</a>';
                                  } ?>&nbsp;</td>
                                  </tr>
                                  <?php
                                  $s2p->MoveNext();
                                ...
                                <tr>
                                  <td colspan="3"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                      ...
                                      if (empty($action)) {
                                        ?>
                                        <tr>
                                          <td align="right" colspan="2"><?php echo '<a href="' . zen_href_link(FILENAME_SHIP2PAY, 'page=' . $_GET['page'] . '&action=new') . '">' . zen_image_button('button_insert.gif', IMAGE_INSERT) . '</a>'; ?></td>
                                        </tr>
                                        <?php
                                      }
                                      ?>
