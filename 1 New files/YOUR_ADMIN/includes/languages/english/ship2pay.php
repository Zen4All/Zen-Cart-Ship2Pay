...
define('TEXT_INFO_SHIPMENT', 'Shipping method:');
define('TEXT_INFO_PAYMENTS', 'Payments selectable at checkout for the shipping method:<br>(use CTRL to select multiple)');
